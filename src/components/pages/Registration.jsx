...
const Registration = () => {
  ...
  const formValidation = () => {
    ...
    if (
      users.chargesperhour.trim() === null ||
      users.chargesperhour.trim() === ""
    ) {
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                {Object.keys(contactNameErr).map((key) => {
                  return (
                    <div style={{ color: "red" }} key="{contactNameErr}">
                      {contactNameErr[key]}
                    </div>
                  );
                })}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                {Object.keys(emailErr).map((key) => {
                  return (
                    <div style={{ color: "red" }} key="{emailErr}">
                      {emailErr[key]}
                    </div>
                  );
                })}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                {Object.keys(passwordErr).map((key) => {
                  return (
                    <div style={{ color: "red" }} key="{passwordErr}">
                      {passwordErr[key]}
                    </div>
                  );
                })}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                {Object.keys(companyNameErr).map((key) => {
                  return (
                    <div style={{ color: "red" }} key="{companyNameErr}">
                      {companyNameErr[key]}
                    </div>
                  );
                })}
            ...
            <div className="form-group row">
              ...
              <div className="col-sm-9">
                ...
                {Object.keys(addressErr).map((key) => {
                  return (
                    <div style={{ color: "red" }} key="{addressErr}">
                      {addressErr[key]}
                    </div>
                  );
                })}
                ...
                <div className="row">
                  <div className="form-group col-sm-6">
                    ...
                    <input
                      ...
                      name="latitude"
                      id="latitude"
                      className="form-control latitude"
                      value={users.latitude}
                      onChange={handleInputChange}
                  ...
                  <div className="form-group col-sm-6">
                    ...
                    <input
                      ...
                      name="longitude"
                      id="longitude"
                      className="form-control longitude"
                      value={users.longitude}
                      onChange={handleInputChange}
                ...
                <div className="row">
                  <div className="form-group col-sm-6">
                    ...
                    {Object.keys(openTimeErr).map((key) => {
                      return (
                        <div style={{ color: "red" }} key="{openTimeErr}">
                          {openTimeErr[key]}
                        </div>
                      );
                    })}
                  ...
                  <div className="form-group col-sm-6">
                    ...
                    {Object.keys(closeTimeErr).map((key) => {
                      return (
                        <div style={{ color: "red" }} key="{closeTimeErr}">
                          {closeTimeErr[key]}
                        </div>
                      );
                    })}
              ...
              <div className="col-sm-7">
                <div className="input-group mb-3">
                  <input
                    ...
                    id="chargesperhour"
                    className="form-control"
                    value={users.chargesperhour}
                    onChange={handleInputChange}
                    placeholder="Enter your one hour charges"
                ...
                {Object.keys(chargesErr).map((key) => {
                  return (
                    <div style={{ color: "red" }} key="{chargesErr}">
                      {chargesErr[key]}
                    </div>
                  );
                })}
