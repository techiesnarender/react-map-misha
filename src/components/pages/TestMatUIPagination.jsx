...
import { Avatar, Box, IconButton, Pagination, styled, Typography } from "@mui/material";
...
function TestMatUIPagination() {
  ...
  const columns = [
    ...
    headerAlign: 'center', },
    { field: 'contactname', headerName: 'Name', width: 150,  headerClassName: 'super-app-theme--header',
    headerAlign: 'center', },
    ...
    headerAlign: 'center', },
    { field: 'address', headerName: 'Address', width: 350,  headerClassName: 'super-app-theme--header',
    headerAlign: 'center', },
    { field: 'open', headerName: 'Open Time', width: 100,  headerClassName: 'super-app-theme--header',
    headerAlign: 'center', },
    { field: 'close', headerName: 'Close Time', width: 100,  headerClassName: 'super-app-theme--header',
    headerAlign: 'center', },
    {
      field: 'Action',
      width: 180,
...
const onChangeSearchCompany = (e) => {
  ...
  const retrieveTutorials = () => {
    setLoading(true);
    const params = getRequestParams(searchAddress, searchCompany, page, pageSize);
